...
export const useUtkastGrunnkretsEndringer = (utkast: UtkastResponse): useUtkastGrunnkretsEndringerReturnType => {
  const [endringer, setEndringer] = useState<Grunnkretsendringer[] | null>(null);
