...
import { getGrenseendringerUtenTilhorighet } from "components/Endringslogg/hooks/endringerUtils";
...
export const useUtkastUtenTilhorighetEndringer = (utkast: UtkastResponse): UseUtkastKommuneEndringerReturnType => {
  const endringer = getGrenseendringerUtenTilhorighet(utkast.operasjoner);
