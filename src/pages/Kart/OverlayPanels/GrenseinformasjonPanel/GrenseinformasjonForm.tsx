...
import { useMergeFeatures } from "pages/Kart/interactions/useMergeFeatures";
...
const GrenseinformasjonForm = ({ feature, onClose }: Props) => {
  ...
  const { featureIsSharedInSammenslaaing } = useMergeFeatures();
  ...
  const isCommonFieldDisabled = isFeatureMetadataEditable(feature) || metadata?.common?.gyldigTil != null;
  ...
  return (
    <FormContainer>
      ...
      <GrenseinformasjonRow
        ...
        valueLabel={
          featureIsSharedInSammenslaaing(feature) && mergeInformasjon != null
            ? mergeInformasjon
            : getValues("informasjon")
        }
        isEditing={isEditing}
      >
