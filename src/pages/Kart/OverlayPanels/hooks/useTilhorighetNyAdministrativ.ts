    ...
    switch (kontekstType) {
      case KontekstType.GRUNNKRETS: {
        return {
          ...
          [Tilhorighet.B]: sortKretserOptionsByName(grunnkretserAsTilhorighetKrets),
        };
      }
      case KontekstType.STEMMEKRETS: {
        return {
          [Tilhorighet.A]: mapStemmekretRefToKrets(stemmekretser),
          [Tilhorighet.B]: sortKretserOptionsByName(stemmekretserAsTilhorighetKrets),
        };
      }
    }
