        ...
        <SidePanel $isOpen={isOpen} className={className}>
            ...
            {(history.entries.length > 0 && history.index > 0) || utkastHarEndringer() ? (
                <Alert>
                    <AlertIcon />
                    <AlertTitle>
                        Du kan ikke gjøre en sammenslåing i et eksisterende utkast som har andre endringer. Avslutt
                        redigeringen av dette utkastet før du gjennomfører sammenslåingen.
                    </AlertTitle>
                </Alert>
            ) : (
                utkastStemmekretser && (
                    <FormProvider {...formMethods}>
                        <Form onSubmit={handleSubmit(handleMerge)}>
                            ...
                            <Alert>
                                <AlertIcon />
                                <AlertTitle>
                                    Legg merke til at det er informasjonen fra denne stemmekretsen som vil beholdes,
                                    mens all informasjon om de resterende stemmekretsene vil bli fjernet i sin helhet
                                    fra inndelingsbasen.
                                </AlertTitle>
                            </Alert>
                            <Divider />
