...
type Props = {
  ...
  mockSammenslaaingInformasjon: string | undefined;
};
      ...
      {isKommuneInndeling(inndeling) ? (
        ...
        <>
          ...
          <InputCell
            isEditing={isEditing}
            isDisabled={disabledDate != null}
            data={mockSammenslaaingInformasjon ?? getValues(`${inndelingId}.informasjon`) ?? inndeling.informasjon}
