...
export interface components {
  schemas: {
    ...
    BopliktomraadeRequest: {
      ...
      materielleVilkaar: (
        "BEBYGDEIENDOM" | "IKKEHELAARSBOLIGUNDEROPPFORING" | "UBEBYGDTOMT" | "UNNTAKFRASLEKTSKAPSUNNTAK"
      )[];
    ...
    Feature: {
      ...
      geometry:
        components["schemas"]["LineString"] | components["schemas"]["MultiPolygon"] | components["schemas"]["Point"];
    };
